        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/e4basil/progressindicatorbutton/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/e4basil/progressindicatorbutton.git")
                        developerConnection.set("scm:git:ssh://github.com/e4basil/progressindicatorbutton.git")
                        url.set("https://github.com/e4basil/progressindicatorbutton/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/e4basil/progressindicatorbutton/issues")
                    }
                }
            }
        }
